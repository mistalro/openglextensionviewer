...
//"<foreach><glext><foreach><extfuncblacklist>extern <funcprefix> _glem_<funcname><funcheader>;\n<endfor><endfor>"
...
"#ifdef <extname>\n"
"<if><cmode><foreach><extfuncblacklist>extern <pfnproc> _glem_<funcname>;\n<endfor><endif>"
"<if><cppmode><foreach><extfuncblacklist><pfnproc> _glem_<funcname>;\n<endfor><endif>"
"#endif\t\t// <extname>\n"
"<end>\n"
...
"<foreach><glext><if><selected><if><funcnum><foreach><extfuncblacklist>#define <funcname>(<funcmacro>) (*_glem_<funcname>)(<funcmacro>) // <funcnumparams> parameters\n<endfor><endif><endif><endfor>"
"<if><wglnum>\n"
"// ----- WGL extensions --------\n"
"\n"
"#ifdef _WIN32\n"
...
"#ifdef <extname>\n"
"<if><cppmode><foreach><extfuncblacklist>\t_glem_<funcname> = NULL;\n<endfor><endif>"
"<if><cmode><foreach><extfuncblacklist><pfnproc>\t_glem_<funcname> = NULL;\n<endfor><endif>"
"#endif\t\t// <extname>\n"
"\n"
"<end>\n"
...
"\treturn;\n"
"<if><funcnum>\n<endif>"
"<foreach><extfuncblacklist>_glem_<funcname> = (<pfnproc>) GetGLProcAddress( \"<funcname>\");\n<endfor>"
"#endif\n"
"}\n"
"\n"
"<end>\n"
