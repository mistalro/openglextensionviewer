...
"<if><cppmode><foreach><extfuncblacklist><pfnproc> _glem_<funcname>_;\n<endfor><endif>"
"#endif\t\t// <extname>\n"
"<end>\n"
...
"<if><cmode><foreach><extfuncblacklist><pfnproc>\t_glem_<funcname>_ = NULL;\n<endfor><endif>"
...
"\treturn;\n"
"<if><funcnum>\n<endif>"
"<foreach><extfuncblacklist>_glem_<funcname>_ = (<pfnproc>) GetGLProcAddress( \"<funcname>\");\n<endfor>"
"#endif\n"
"}\n"
"\n"
"<end>\n"
