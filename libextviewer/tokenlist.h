...
#define TOKEN_STRING_CONFIGFILE	    (0x0036|TOKEN_STRING)
#define TOKEN_STRING_SCRIPTFILE	    (0x0037|TOKEN_STRING)
#define TOKEN_STRING_PATH	    (0x0038|TOKEN_STRING)
#define TOKEN_STRING_WGLCOUNTER	    (0x0039|TOKEN_STRING)
#define TOKEN_STRING_GLCOUNTER	    (0x003A|TOKEN_STRING)
#define TOKEN_STRING_GLXCOUNTER	    (0x003B|TOKEN_STRING)
#define TOKEN_STRING_STRING	    (0x003C|TOKEN_STRING)
#define TOKEN_STRING_WGLMAX	    (0x003D|TOKEN_STRING)
#define TOKEN_STRING_GLMAX	    (0x003E|TOKEN_STRING)
#define TOKEN_STRING_GLXMAX	    (0x003F|TOKEN_STRING)
#define TOKEN_STRING_TAB	    (0x0040|TOKEN_STRING)
#define TOKEN_STRING_NEWLINE	    (0x0041|TOKEN_STRING)
#define TOKEN_STRING_QUOTES	    (0x0042|TOKEN_STRING)
#define TOKEN_STRING_FUNCMAX	    (0x0043|TOKEN_STRING)
#define TOKEN_STRING_FUNCPROTO	    (0x0044|TOKEN_STRING)
#define TOKEN_STRING_FUNCPREFIX	    (0x0045|TOKEN_STRING)
#define TOKEN_STRING_FUNCCOUNTER    (0x0046|TOKEN_STRING)
#define TOKEN_STRING_FUNCNAME	    (0x0047|TOKEN_STRING)
#define TOKEN_STRING_FUNCHEADER	    (0x0048|TOKEN_STRING)
#define TOKEN_STRING_CONSTMAX	    (0x0049|TOKEN_STRING)
#define TOKEN_STRING_CONSTVALUE	    (0x004A|TOKEN_STRING)
#define TOKEN_STRING_CONSTCOUNTER   (0x004B|TOKEN_STRING)
#define TOKEN_STRING_CONSTNAME	    (0x004C|TOKEN_STRING)
#define TOKEN_STRING_EXTREGISTRYCOUNTER (0x004D|TOKEN_STRING)
