...
#ifndef _EXTHEADERFILEFUNCGLX_H_
#define _EXTHEADERFILEFUNCGLX_H_
...
class CExtensionHeaderFileFuncGLX : virtual public CExtensionHeaderFileData,
 	                            virtual public CExtensionHeaderFileFunc

{
public:
const CExtensionHeaderFileFuncGLX & operator = ( const CExtensionHeaderFileFuncGLX &src )
        {
...
void FuncInit( void )
	{
        const std::string str_prefix     = "GLX_";
        const std::string str_funcprefix = "glX";
        const std::string str_proto      = "GLX_GLXEXT_PROTOTYPES";
	const std::string str_listname   = "glx";
	Init();
...
#endif	// _EXTHEADERFILEFUNCGLX_H_
