...
#ifndef _EXTHEADERFILEFUNCVENDOR_H_
#define _EXTHEADERFILEFUNCVENDOR_H_
...
class CExtensionHeaderFileFuncVendor : virtual public CExtensionEntryList,
...
#endif	// _EXTHEADERFILEFUNCVENDOR_H_
