...
#ifndef _EXTHEADERFILEFUNCSYSTEM_H_
#define _EXTHEADERFILEFUNCSYSTEM_H_
...
class CExtensionHeaderFileFuncSystem : virtual public CExtensionEntryList,
...
#endif	// _EXTHEADERFILEFUNCSYSTEM_H_
