...
#ifndef _EXTHEADERFILEFUNCGL_H_
#define _EXTHEADERFILEFUNCGL_H_
...
class CExtensionHeaderFileFuncGL : virtual public CExtensionHeaderFileData,
                                    virtual public CExtensionHeaderFileFunc
{
public:
const CExtensionHeaderFileFuncGL & operator = ( const CExtensionHeaderFileFuncGL &src )
        {
	this->Duplicate( src );	
...
void FuncInit( void )
	{
        ...
        const string str_funcprefix = "gl";
